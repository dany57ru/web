...
class Originator
{
    ...
    {
        $this->state = $state;
        echo "Создатель: Мое первоначальное состояние таково: {$this->state}\n";
    }
    ...
    public function doSomething(): void
    {
        ...
        echo "Создатель: и мое состояние изменилось на: {$this->state}\n";
    }
    ...
    public function restore(Memento $memento): void
    {
        ...
        echo "Создатель: Мое состояние изменилось на: {$this->state}\n";
    }
}
...
class Caretaker
{
    ...
    {
        echo "\nХранитель: Сохранение состояния отправителя...\n";
    ...
    public function undo(): void
    {
        ...
        echo "Хранитель: Восстановление состояния до: " . $memento->getName() . "\n";
        try {
    ...
    {
        echo "Хранитель: Вот список сувениров:\n";
...
echo "\nКлиент: А теперь давайте сделаем откат назад!\n\n";
$caretaker->undo();
