...
abstract class AbstractClass
{
    ...
    {
        echo "AbstractClass говорит: я выполняю основную часть работы\n";
    }

    protected function baseOperation2(): void
    {
        echo "AbstractClass говорит: Но я позволяю подклассам переопределять некоторые операции\n";
    }

    protected function baseOperation3(): void
    {
        echo "AbstractClass говорит: Но я все равно выполняю основную часть работы\n";
    }
...
class ConcreteClass1 extends AbstractClass
{
    ...
    {
        echo "В ConcreteClass1 говорится: Реализованная операция1\n";
    }

    protected function requiredOperation2(): void
    {
        echo "В ConcreteClass1 говорится: Реализованная операция2\n";
    }
}
...
class ConcreteClass2 extends AbstractClass
{
    protected function requiredOperations1(): void
    {
        echo "В ConcreteClass2 говорится: Реализованная операция1\n";
    }

    protected function requiredOperation2(): void
    {
        echo "В ConcreteClass2 говорится: Реализованная операция2\n";
    }

    protected function hook1(): void
    {
        echo "ConcreteClass2 говорит: Переопределенный Hook1\n";
    }
}
