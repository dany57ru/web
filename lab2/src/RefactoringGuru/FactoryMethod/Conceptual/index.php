...
abstract class Creator
{
    ...
    public function someOperation(): string
    {
        ...
        $result = "Создатель: Код того же создателя, который только что работал с " .
            $product->operation();
...
{
    // ...
    echo "Клиент: Я не знаю о классе создателя, но он все еще работает.\n"
 ...
 * среды.
 */
echo "Приложение: Запущено с помощью ConcreteCreator1.\n";
