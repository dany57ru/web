...
class Flyweight
{
    ...
    public function operation($uniqueState): void
    {
        ...
        echo "Flyweight: Отображение общего ($s) и уникального ($u) состояния.\n";
    }
}
...
class FlyweightFactory
{
    ...
    public function getFlyweight(array $sharedState): Flyweight
    {
        ...
        if (!isset($this->flyweights[$key])) {
            echo "FlyweightFactory: Не могу найти подходящий груз, создаю новый.\n";
            $this->flyweights[$key] = new Flyweight($sharedState);
        } else {
            echo "FlyweightFactory: Повторное использование существующего махового веса.\n";
        }
...
function addCarToPoliceDatabase(
    ...
    echo "\nКлиент: Добавление автомобиля в базу данных.\n";
