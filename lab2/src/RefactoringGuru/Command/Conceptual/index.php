...
class SimpleCommand implements Command
{
    ...
    public function execute(): void
    {
        echo "SimpleCommand: Видите ли, я могу делать простые вещи, такие как печать (" . $this->payload . ")\n";
    }
}
...
class ComplexCommand implements Command
{
    ...
    public function execute(): void
    {
        echo "ComplexCommand: Сложные действия должны выполняться объектом-получателем.\n";
...
class Receiver
{
    ...
    {
        echo "Приемник: Работает над (" . $a . ".)\n";
    }

    public function doSomethingElse(string $b): void
    {
        echo "Приемник: Также работает над (" . $b . ".)\n";
    }
}
...
class Invoker
{
    ...
    {
        echo "Приглашающий: Кто-нибудь хочет что-нибудь сделать, прежде чем я начну?\n";
        if ($this->onStart instanceof Command) {
            $this->onStart->execute();
        }

        echo "Приглашающий: ...делаю что-то действительно важное...\n";

        echo "Приглашающий: Кто-нибудь хочет, чтобы что-то было сделано после того, как я закончу?\n";
